	...
	while (1) {
		...
		if (whichc == 1) {
			...
			switch(repstage) {
				...
				case 2: { 
					NR12_REG = sndval; delay(delval);
					break; 
				}
				case 3: { 
					NR13_REG = sndval; delay(delval);
					break; 
				}
				case 4: { 
					NR14_REG = sndval; delay(delval);
					break;
				}
				default: break;
			}
		...
		if (whichc == 2) {
			...
			switch(repstage) {
				...
				case 1: { 
					NR22_REG = sndval; delay(delval);
					break; 
				}
				case 2: { 
					NR23_REG = sndval; delay(delval);
					break; 
				}
				case 3: { 
					NR24_REG = sndval; delay(delval);
					break; 
				}
				default: break;
			}
		...
		if (whichc == 3) {
			...
			switch(repstage) {
				...
				case 1: {
					NR31_REG = sndval; delay(delval);
					break;
				}
				case 2: {
					NR32_REG = sndval; delay(delval);
					break;
				}
				case 3: {
					NR33_REG = sndval; delay(delval);
					break;
				}
				case 4: {
					NR34_REG = sndval; delay(delval);
					break;
				}
				default: break;
			}
		...
		if (whichc == 4) {
			...
			switch(repstage) {
				...
				case 1: {
					NR42_REG = sndval; delay(delval);
					break;
				}
				case 2: {
					NR43_REG = sndval; delay(delval);
					break;
				}
				case 3: {
					NR44_REG = sndval; delay(delval);
					break;
				}
				default: break;
			}
